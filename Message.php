...
<body>
    <div class="NavBar">
        <nav>
            ...
            <a class="NavItem active" href="Message.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="Main">
        <section>
            ...
            <form method="POST" action="php/message.php">
                ...
                <div class="Input_Group">
                    <div class="Input_Field">
                        <input name="EmailID" class="Input" type="text" placeholder="E-mail Id" required>
                    </div>
                    <div class="Input_Field">
                        <input name="LinkedInID" class="Input" type="text" placeholder="LinkedIn Profile Link" required>
                    </div>
                </div>
                <div class="Input_Field">
                    <textarea name="Message" placeholder="Your Message ..." required data-bs-toggle="tooltip"
                data-bs-placement="top"
                data-bs-original-title="Please don't use special characters in Message."></textarea>
                </div>
                <div class="Button">
