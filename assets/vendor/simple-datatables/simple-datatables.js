                  ...
                  template: (t, e) =>
                    `<div class='${t.classes.top}'>\n    ${
                      t.paging && t.perPageSelect
                        ? `<div class='d-flex col-5 d-kb-none ${t.classes.dropdown}'>\n                  <select class='form-select ${t.classes.selector}'></select>     <span class='col-10 m-2'>\n      ${t.labels.perPage}\n            </span>\n        </div>`
                        : ""
                    }\n    ${
                      t.searchable
                        ? `<div class='${
                ...
                editCellModal() {
                  const t = this.data.cell,
                    ...
                    a = [
                      ...
                      `<input class='form-control ${this.options.classes.input}' value='${n(
