...
<body>
    <div class="NavBar">
        <nav>
            ...
            <a class="NavItem active" href="Details.php">
    ...
    <div class="Main">
        <section>
            <h1>Objective</h1>
            <p class="Objective_Data">A highly motivated and detail-oriented individual seeking an internship opportunity in your company to
                apply and enhance my skills in Artificial Intelligence or Web Development and contribute to the
            ...
            <!-- Edu Cards -->
                <div class="Card">
                    ...
                    <div class="Edu_Details">
                        <p><b>Running : </b>B.Tech 2<sup>nd</sup> Year</p>
                        <p><b>Branch : </b>Artificial Intelligence</p>
                        <p><b>College : </b>Parul University</p>
                    </div>
                </div>
                ...
                <div class="Card">
                    ...
                    <div class="Edu_Details">
                        <p><b>Completed : </b>B.Tech 1<sup>st</sup> Year</p>
                        <p><b>Branch : </b>Artificial Intelligence</p>
                        <p><b>College : </b>Parul University</p>
                        <p><b>CGPA : </b>7.8 / 10</p>
                    </div>
                ...
                <div class="Card">
                    ...
                    <div class="Edu_Details">
                        <p><b>Completed : </b>JEE Mains</p>
                        <p><b>CGPA : </b>85.44 PR</p>
                    </div>
                </div>
                ...
                <div class="Card">
                    ...
                    <div class="Edu_Details">
                        <p><b>Complete : </b>GHSEB Board</p>
                        <p><b>Stream : </b>Science ( A-Group )</p>
                        <p><b>Percentage : </b>78.15%</p>
                    </div>
                </div>
                ...
                <div class="Card">
                    ...
                    <div class="Edu_Details">
                        <p><b>Complete : </b>GSEB Board</p>
                        <p><b>Percentage : </b>88.83%</p>
                    </div>
                </div>
